...
from services.granja.mortalidade_service import MortalidadeService as Servico
from schemas.granja.mortalidade_schema import MortalidadeSchema as Schema
