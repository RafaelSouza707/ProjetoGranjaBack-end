...
class TipoProdutoResource(Resource):
    ...
    def get(self, id=None):
        if id:
            cache_key = f"tipo_produto:{id}"
            dados =cache.get(cache_key)
            if dados is not None:
                print("CHACHE USADO") # Apenas para testar o uso do cache. O print Será retirado na proxima atualização.
                return dados
    ...
    def put(self, id):
        ...
        cache.delete("tipo_produto")
        cache.delete(f"tipo_produto:{id}")
