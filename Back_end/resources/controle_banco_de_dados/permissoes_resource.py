...
from services.controle_banco_de_dados.permissoes_service import PermissaoService as Servico
from schemas.controle_banco_de_dados.permissoes_schema import PermissoesSchema as Schema
