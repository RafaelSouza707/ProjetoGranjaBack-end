...
from services.usuarios.conta_adm_service import ContaADMService as Servico
from schemas.usuarios.conta_adm_schema import ContaADMSchema as Schema

schema = Schema()
schemas = Schema(many=True)

class  ContaADMResource(Resource):
