...
def deletar_cache(granja_id):
    cache.delete(f"cache:granja:{granja_id}:producao")
...
class ProducaoResource(Resource):
    ...
    def get(self):
        ...
        lote_frango_id = request.args.get("lote_frango", type=int)
        lote_frango = LoteFrangoService.buscar_por_id(lote_frango_id)
        granja_id = lote_frango.granja_id
    ...
    def delete(self, id):
        ...
        with session_scope():
            ...
            lote_granja_id = delete.lote_frango_id
            lote_frango = LoteFrangoService.buscar_por_id(lote_granja_id)
            granja_id = lote_frango.granja_id
            ValidarAcessoGranja.validar_acesso_granja(user_id, granja_id)
